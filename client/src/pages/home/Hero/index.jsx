...
export default function Hero() {
  return (
    <section className="relative flex min-h-[calc(100vh-4rem)] w-full items-center justify-center py-16 md:py-24 lg:py-32">
      <div className="container relative flex h-full w-full max-w-7xl flex-col items-center justify-center px-4 md:px-8 overflow-x-clip">
        <div className="flex flex-col items-center justify-center text-center z-10">
          ...
          <Link className="mx-auto" to="/auth/signup">
            <Button
              size="lg"
              className="h-12 px-8 text-base font-medium rounded-full cursor-pointer"
            >
